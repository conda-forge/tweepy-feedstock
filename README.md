...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/tweepy-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/tweepy-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/tweepy-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/tweepy-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/tweepy-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/tweepy-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `tweepy` can be installed with:

```
conda install tweepy
```

It is possible to list all of the versions of `tweepy` available on your platform with:
